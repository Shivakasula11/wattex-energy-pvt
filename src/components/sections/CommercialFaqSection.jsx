...
const FAQ_TABS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much maintenance cost should we budget?', a: 'Annual maintenance costs are typically 1-2% of the system cost. Our 5-year AMC (Annual Maintenance Contract) covers quarterly cleaning, inverter health checks, wiring inspections, and performance monitoring — ensuring your system operates at peak efficiency throughout.' },
  ...
  },
  {
    ...
    label: 'Technical',
    faqs: [
      { q: 'How long does a commercial installation take?', a: 'A standard commercial rooftop installation (50-200kW) takes 4-8 weeks from approval to commissioning. Larger projects (500kW+) may take 8-12 weeks. This includes structural analysis, engineering design, procurement, installation, testing, and grid connection coordination.' },
      ...
      { q: 'What warranty coverage do commercial systems get?', a: '25-year performance warranty on solar panels (guaranteed 80%+ output at Year 25), 10-year warranty on inverters, 5-year warranty on mounting structures, and 5-year comprehensive AMC. We also provide real-time remote monitoring for immediate issue detection.' },
