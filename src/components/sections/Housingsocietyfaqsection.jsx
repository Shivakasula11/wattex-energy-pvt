          ...
          <div className="lg:col-span-5">
            <div className="space-y-6 mt-16">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3]">
                <img
                  src="https://media.istockphoto.com/id/1457768039/photo/two-engineers-installing-solar-panels-on-roof.webp?a=1&b=1&s=612x612&w=0&k=20&c=if3NkZdskzbuNelXcFKGX7GDYdLRupn453NBnP69ROI="
