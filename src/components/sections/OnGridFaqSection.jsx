          ...
          <div className="lg:col-span-5">
            <div className="space-y-6 lg:mt-16 lg:sticky lg:top-32">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3]">
                <img
                  src="https://media.istockphoto.com/id/948882160/photo/human-hand-touching-a-solar-panel.webp?a=1&b=1&s=612x612&w=0&k=20&c=iAY5SwI0atSCKVKsEBli3vDX1RKPK1YtaXwxLsqMzwQ="
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <h3 className="text-white text-2xl font-black leading-tight">
                    5kW rooftop system<br />₹250 monthly bill
                  </h3>
                </div>
              </div>
