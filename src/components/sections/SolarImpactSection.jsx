      ...
      <div className="grid lg:grid-cols-2 gap-24 items-center">
        <div className="space-y-12">
          <div className="space-y-4">
            ...
            <h2 className="text-5xl font-black text-solar-deep tracking-tight">The Power of the Sun</h2>
        ...
        <div className="relative">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4 pt-12">
              <img src="https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&q=80&w=600" className="rounded-3xl shadow-2xl w-full aspect-[3/4] object-cover" alt="Solar Panel Close" />
              <img src="https://images.unsplash.com/photo-1542332213-9b5a5a3fad35?auto=format&fit=crop&q=80&w=600" className="rounded-3xl shadow-2xl w-full aspect-square object-cover" alt="Solar Field" />
            </div>
            <div className="space-y-4">
              <img src="https://images.unsplash.com/photo-1559302995-f0a16a50083c?auto=format&fit=crop&q=80&w=600" className="rounded-3xl shadow-2xl w-full aspect-square object-cover" alt="Clean Energy" />
              <img src="https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?auto=format&fit=crop&q=80&w=600" className="rounded-3xl shadow-2xl w-full aspect-[3/4] object-cover" alt="Commercial Solar" />
            </div>
          </div>
